...
public class Edicao {
    ...
    public Edicao(int id,int idProduto, String campo, String valorAnterior, String valorAtual, int sugeridoPor, Timestamp timeStampSugestao, boolean aceito, int avaliadoPor, Timestamp timestampAlteracao) {
        this.id = id;
